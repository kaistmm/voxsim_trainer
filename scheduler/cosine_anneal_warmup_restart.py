...
def Scheduler(optimizer, first_cycle_steps, cycle_mult, max_lr, min_lr, warmup_steps, gamma, **kwargs):
    
    sche_fn = CosineAnnealingWarmupRestarts(optimizer, first_cycle_steps, cycle_mult, max_lr, min_lr, warmup_steps, gamma)
